...
Here, I will test my function. Using *expect_()* functions and *test_that()* form the *testthat* package, I will make sure that my function works as intended. Each code chunk below will contain a test for my function. 
